...
const Banner = () => {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        const res = await axiosInstance.get("/api/movies/latest?page=2");
    ...
    <div className="movie-list-with-banner">
      ...
      {bannerMovies.length > 0 && (
        <div 
          ...
          style={{ 
            backgroundImage: `linear-gradient(to right, rgba(0,0,0,0.7) 0%, rgba(0,0,0,0) 100%), url(${bannerMovies[currentBanner]?.bg})` 
          }}
        >
